...
def dataload(args, augmentations, normalize, data_info):
    if args.dataset == 'CIFAR10':
        train_dataset = datasets.CIFAR10(
            root=os.path.join(args.data_path,'cifar-10'), train=True, transform=augmentations)
        ...
        train_dataset = datasets.CIFAR100(
            root=os.path.join(args.data_path,'cifar-100'), train=True,transform=augmentations)
